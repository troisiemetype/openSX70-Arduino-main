...
#ifndef OPENSX70_HARDWARE_H
#define OPENSX70_HARDWARE_H

void hw_shutter_open();
void hw_shutter_maintain();
void hw_shutter_close();

void hw_flash_exp_open();
void hw_flash_exp_maintain();
void hw_flash_exp_close();

void hw_release_mirror();
void hw_eject();
void hw_eject_darkslide(); // (= release mirror + eject darkslide)
